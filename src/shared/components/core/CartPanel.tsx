...
import {selectCartList, selectorTotalCartCost, useCart, useCartPanel} from "../../../services/cart";
...
export function CartPanel() {
    ...
    return (
        <div className="fixed bg-slate-800 right-4 top-24 p-3 rounded-xl shadow-2xl w-96">
            <span onClick={closeCartPanel} className="flex justify-end mb-3 font-bold cursor-pointer">x</span>
